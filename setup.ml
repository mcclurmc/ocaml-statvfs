...
(* OASIS_START *)
(* DO NOT EDIT (digest: 232ea22809d95cdf4f42e65837f54aae) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./statvfs_test.byte", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Ctypes binding for OSX and Linux statvfs syscall";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "statvfs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "statvfs_test.ml"})
            ];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\014|\022\151ª{8ï´0\157\132,z\0263";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
