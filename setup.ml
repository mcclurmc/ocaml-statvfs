...
(* OASIS_START *)
(* DO NOT EDIT (digest: caa3459531ec669bdb5067c69ae48196) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./statfs_test.byte", []))];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "statfs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "statfs_test.ml"})
            ];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "¤f-¢èr|\128æö<VÜ=¶Ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
